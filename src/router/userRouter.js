...
class UserRouter {
    ...
    this.router.put('/users/:id', asyncHandle(this.authMiddleware.checkAuth), asyncHandle(this.userMiddleware.checkUser), asyncHandle(this.userController.updateUser));
